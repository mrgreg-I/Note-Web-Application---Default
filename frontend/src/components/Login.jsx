...
const Login = ({ onLogin }) => {
 ...
 try {
  ...
  console.log('Login response:', response.data); // Check this in your browser console

  // Use the correct property name based on the actual response
  const userId = response.data.userId; // <-- Use userId, not id
